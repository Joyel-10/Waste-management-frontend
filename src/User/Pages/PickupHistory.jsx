                    ...
                    <div className="bg-white shadow-2xl rounded-2xl p-6 md:p-8 border border-emerald-100 relative overflow-hidden">
                        ...
                        {pickupData.length === 0 ? (
                            <div className="text-center py-16">
                                ...
                                <p className="text-xl text-gray-500 font-medium">No pickup history found.</p>
                                <p className="text-gray-400 mt-2">Schedule your first pickup to get started!</p>
                            </div>
                        ) : (
                            <div className="space-y-4">
                                {pickupData.map((pickup, index) => (
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <p className="text-xl font-bold text-gray-800 mb-1">{pickup.wasteType}</p>
                                                <div className="flex items-center gap-2 text-gray-600 text-sm mb-2">
                                        ...
                                        {pickup.status === "Scheduled" && (
                                            <div className="flex gap-3 sm:flex-col lg:flex-row">
                                                <button
                                                    onClick={() => navigate("/schedule-pickup", { state: { pickup } })}
                                                    disabled={cancellingId === pickup._id}
                                                    className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                                >
                                                    Reschedule
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    disabled={cancellingId === pickup._id}
                                                    className="bg-gradient-to-r from-rose-500 to-red-500 hover:from-rose-600 hover:to-red-600 text-white px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                                >
                                                    {cancellingId === pickup._id ? (
                                                        <>
